...
def validate_page(page: Path) -> list[str]:
    ...
    if page.name == 'index.html':
        ...
        required_ids = {
            ...
            'comparison-left-suggestions-panel', 'comparison-right-suggestions-panel',
            'comparison-left-suggestions', 'comparison-right-suggestions',
            'comparison-left-suggestions-note', 'comparison-right-suggestions-note',
            'comparison-left-search-status', 'comparison-right-search-status',
